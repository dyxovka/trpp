...
public class FragmentCalendarBindingImpl extends FragmentCalendarBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.button_calendar_main, 2);
        sViewsWithIds.put(R.id.button_calendar_profile, 3);
        sViewsWithIds.put(R.id.button_calendar_calendar, 4);
        sViewsWithIds.put(R.id.button_calendar_categories, 5);
    }
    // views
    @NonNull

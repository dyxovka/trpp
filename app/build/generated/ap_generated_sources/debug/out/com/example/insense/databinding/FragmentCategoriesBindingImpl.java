...
public class FragmentCategoriesBindingImpl extends FragmentCategoriesBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.button_categories_main, 2);
        sViewsWithIds.put(R.id.button_categories_profile, 3);
        sViewsWithIds.put(R.id.button_categories_calendar, 4);
        sViewsWithIds.put(R.id.button_categories_categories, 5);
    }
    // views
    @NonNull
